...
settings:
    ...
    -
        ...
        title.zh: 版本
        type: info-text
        description: "v2.1.02E"
        description.zh: "v2.1.02E"
    -
        id: zendian-changelog
        title: Changelog
        title.zh: 版本记录
        type: info-text
        description: "**v2.1.02E** — Dynamic icon system<br>- Data-driven file tree icons with regex matching<br>- Lucide built-in + Boxicons/Coolicons/Tabler support<br>- Icon picker modal with grid layout<br>- Right-click custom icons per file<br>- Tab icons for workspace tabs<br>**v1.0.0** — Initial release<br>- Merged Border theme, Phycat overlay, and Style Settings<br>- Apple-style settings panel with sidebar navigation<br>- Full Chinese localization<br>- Rainbow folder support<br>- Theme accent color sync with Obsidian<br>- Default card layout with grid background"
        description.zh: "**v2.1.02E** — 动态图标系统<br>- 数据驱动文件树图标，正则匹配引擎<br>- 内置 Lucide + Boxicons/Coolicons/Tabler 图标库<br>- 图标选择器弹窗，CSS Grid 多列网格<br>- 右键自定义单个文件图标<br>- 标签页图标显示<br>**v1.0.0** — 首发版本<br>- 整合 Border 主题、Phycat 覆盖层与 Style Settings<br>- 苹果风格设置面板，侧边栏导航<br>- 全面中文本地化<br>- 彩虹文件夹支持<br>- 主题色与 Obsidian 同步<br>- 默认卡片布局与网格背景"
        markdown: true
*/
`;
